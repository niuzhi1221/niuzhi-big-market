package com.niuzhi.domain.strategy.service.rule.tree.factory.engine.impl;

import com.niuzhi.domain.strategy.model.vo.RuleLogicCheckTypeVO;
import com.niuzhi.domain.strategy.model.vo.RuleTreeNodeLineVO;
import com.niuzhi.domain.strategy.model.vo.RuleTreeNodeVO;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardVO process(String userId, Long strategyId, Integer awardId) {
        ...
        while(null != nextNode) {
            ...
            //  决策节点计算
            DefaultTreeFactory.TreeActionEntity logicEntity = logicTreeNode.loigc(userId, strategyId, awardId, ruleValue);
